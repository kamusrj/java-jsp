...
<html>
    <head>
        ...
        <title>Inventario Alquiler</title>
    </head>
    <body>
        <%
        ...
        <div class="row">
            ...
            <div class="col m1">
                <a href="Control?act=addInAlqui" data-position="left" data-tooltip="Agregar producto" class="btn tooltipped btn-block large waves-effect waves-block waves-green blue lighten-1">
                    ...
                    <div class="card horizontal">
                        ...
                        <div class="card-stacked">
                            <div class="card-content">
                                ...
                                <h5>Costo: <b>$${li.libro.costo}</b></h5>
                                    <h5>Existencia: <b>${li.existencia}</b></h5>
                            </div>
                        </div>
                    </div>
                </c:forEach>
